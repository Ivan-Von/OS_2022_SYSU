...
public:
    ...
    //int allocatePhysicalPages(enum AddressPoolType type, const int count,int* array,int* size,int* num);
    ...
    // 页内存分配
    int allocatePages(enum AddressPoolType type, const int count,int* array,int& size,int& index);
    ...
    /*
    //visit list
    void visit_array(enum AddressPoolType type,const int virtualAddress,const int count,int array[3]);
    */
};
